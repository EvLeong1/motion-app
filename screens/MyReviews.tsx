...
import { globalStyles, reviewStyles, viewParks } from '../styles/globalStyles';
import { User } from 'firebase/auth';

type MyReviewsProps = NativeStackScreenProps<RootStackParamList, 'MyReviews'>;

const MyReviews = ({ route }: MyReviewsProps) => {
        ...
        : (
          <ScrollView contentContainerStyle={viewParks.container}>
            ...
            <View key='Small World' style={reviewStyles.reviewBox}>
              ...
              <View style={reviewStyles.textContainer}>
                <Text style={reviewStyles.textContent}>
                  Ride was really fun but I threw up 45 times afterward. I would
                  not recommend this ride to people with motion sickness.
                </Text>
              </View>
            </View>
            ...
            <View key='Cars Ride' style={reviewStyles.reviewBox}>
              ...
              <View style={reviewStyles.textContainer}>
                <Text style={reviewStyles.textContent}>
                  I love this ride so much I like when I race the other car but
                  I never win and sometimes I get really mad and I have to take
                  out my anger on my Winnie the Pooh plushie. Definitely
                  recommend this ride to people with motion sickness.
                </Text>
              </View>
            </View>
